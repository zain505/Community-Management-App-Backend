...
applyEnvAlias('SERVICE_NAME', ['STORE_SERVICE_NAME']);
applyEnvAlias('PORT', ['STORE_SERVICE_PORT']);
applyEnvAlias('DATABASE_URL', ['STORE_SERVICE_DATABASE_URL', 'STORE_DATABASE_URL']);
